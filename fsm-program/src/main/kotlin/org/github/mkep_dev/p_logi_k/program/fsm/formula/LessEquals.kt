...
/**
 * The representation of a *less than or equals* compare. It takes two number and returns a boolean.
 *
 ...
 */
class LessEquals<T : Any>(lhsOperand: Operand<T>, rhsOperand: Operand<T>) :
    ...
    companion object {
        infix fun <T : Any> Operand<T>.le(other: Operand<T>) = LessEquals(this, other)
    }
}