...
/**
 * The representation of a *less than* compare. It takes two numbers and returns a boolean.
 *
 ...
 */
class LessThan<T : Any>(lhsOperand: Operand<T>, rhsOperand: Operand<T>) :
    ...
    companion object {
        infix fun <T : Any> Operand<T>.lt(other: Operand<T>) = LessThan(this, other)
    }
