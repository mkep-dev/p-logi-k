...
/**
 * The representation of a *greater than or equals* compare. It takes two numbers and returns a boolean.
 *
 ...
 */
class GreaterEquals<T : Any>(lhsOperand: Operand<T>, rhsOperand: Operand<T>) :
    ...
    companion object {
        infix fun <T : Any> Operand<T>.ge(other: Operand<T>) = GreaterEquals(this, other)
    }
